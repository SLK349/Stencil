...
import { a as findClosestIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './p-1db1f9e2.js';
import { g as getIonMode } from './p-7ff156a4.js';

const infiniteScrollCss = "ion-infinite-scroll{display:none;width:100%}.infinite-scroll-enabled{display:block}";
const IonInfiniteScrollStyle0 = infiniteScrollCss;

const InfiniteScroll = /*@__PURE__*/ proxyCustomElement(class InfiniteScroll extends H {
    constructor() {
        super();
        this.__registerHost();
