...
import { n as assert, s as shallowEqualStringMap } from './p-4e0d3630.js';
import { l as lifecycle, t as transition, s as setPageHidden, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE } from './p-1ac7a4bf.js';
...
const Nav = /*@__PURE__*/ proxyCustomElement(class Nav extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    async componentDidLoad() {
        ...
        this.didLoad = true;
        this.rootChanged();
        this.gesture = (await import('./p-05e76d51.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
