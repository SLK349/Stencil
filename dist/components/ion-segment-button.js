...
import { a as addEventListener, b as removeEventListener, d as inheritAttributes } from './p-4e0d3630.js';
...
let ids = 0;
const SegmentButton = /*@__PURE__*/ proxyCustomElement(class SegmentButton extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
