...
const Refresher = class {
    ...
    async checkNativeRefresher() {
        const useNativeRefresher = await refresher_utils.shouldUseNativeRefresher(this.el, ionicGlobal.getIonMode(this));
    ...
    async resetNativeRefresher(el, state) {
        ...
        if (ionicGlobal.getIonMode(this) === 'ios') {
            await refresher_utils.translateElement(el, undefined, 300);
        }
        else {
    ...
    async setupiOSNativeRefresher(pullingSpinner, refreshingSpinner) {
            ...
            index.readTask(() => {
                ...
                if (scrollTop > 0) {
                    ...
                    if (this.state === 8 /* RefresherState.Refreshing */) {
                        ...
                        index.writeTask(() => refresher_utils.setSpinnerOpacity(refreshingSpinner, 1 - ratio));
                        return;
                    }
                    return;
                }
                ...
                if (shouldShowRefreshingSpinner) {
                    if (this.pointerDown) {
                        refresher_utils.handleScrollWhileRefreshing(refreshingSpinner, this.lastVelocityY);
                    }
                    if (!this.didRefresh) {
                        this.beginRefresh();
                         ...
                         */
                        if (!this.pointerDown) {
                            refresher_utils.translateElement(this.elementToTransform, `${refresherHeight}px`);
                        }
                    }
                }
                else {
                    this.state = 2 /* RefresherState.Pulling */;
                    refresher_utils.handleScrollWhilePulling(ticks, NUM_TICKS, pullAmount);
                }
            });
        };
        ...
        this.gesture = (await Promise.resolve().then(function () { return require('./index-63bd8011.js'); })).createGesture({
            ...
            onStart: () => {
                ...
                if (!this.didRefresh) {
                    refresher_utils.translateElement(this.elementToTransform, '0px');
                }
                /**
            ...
            onEnd: () => {
                ...
                if (this.needsCompletion) {
                    ...
                    index.readTask(() => refresher_utils.translateElement(this.elementToTransform, `${this.el.clientHeight}px`));
                }
            },
        });
        ...
        this.gesture = (await Promise.resolve().then(function () { return require('./index-63bd8011.js'); })).createGesture({
            ...
            onMove: (ev) => {
                ...
                if (!ev.data.didStart) {
                    ...
                    const animationType = refresher_utils.getRefresherAnimationType(contentEl);
                    const animation = refresher_utils.createPullingAnimation(animationType, pullingRefresherIcon, this.el);
            ...
            onEnd: (ev) => {
                ...
                const snapBackAnimation = refresher_utils.createSnapBackAnimation(pullingRefresherIcon);
    ...
    async connectedCallback() {
        ...
        helpers.componentOnReady(contentEl, async () => {
            ...
            if (await refresher_utils.shouldUseNativeRefresher(this.el, ionicGlobal.getIonMode(this))) {
                this.setupNativeRefresher(contentEl);
            }
            else {
                this.gesture = (await Promise.resolve().then(function () { return require('./index-63bd8011.js'); })).createGesture({
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e7f4f2f96de7e80430bf54967ebc12e7216b2ca9', slot: "fixed", class: {
                [mode]: true,
