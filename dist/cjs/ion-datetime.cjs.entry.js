...
const focusVisible = require('./focus-visible-e882cff3.js');
const helpers = require('./helpers-0f03deef.js');
const index = require('./index-7d4ba1aa.js');
...
const data = require('./data-fea16d94.js');
...
`, this.el);
    ...
    renderCombinedDatePickerColumn() {
        ...
        return (index$1.h("ion-picker-column", { class: "date-column", color: this.color, disabled: disabled, value: todayString, onIonChange: (ev) => {
    ...
    renderDayPickerColumn(days) {
        ...
        return (index$1.h("ion-picker-column", { class: "day-column", color: this.color, disabled: disabled, value: pickerColumnValue, onIonChange: (ev) => {
    ...
    renderMonthPickerColumn(months) {
        ...
        const { disabled, workingParts } = this;
        const activePart = this.getActivePartsWithFallback();
        return (index$1.h("ion-picker-column", { class: "month-column", color: this.color, disabled: disabled, value: workingParts.month, onIonChange: (ev) => {
    ...
    renderYearPickerColumn(years) {
        ...
        const { disabled, workingParts } = this;
        const activePart = this.getActivePartsWithFallback();
        return (index$1.h("ion-picker-column", { class: "year-column", color: this.color, disabled: disabled, value: workingParts.year, onIonChange: (ev) => {
    ...
    renderHourPickerColumn(hoursData) {
        ...
        if (hoursData.length === 0)
            return [];
        const activePart = this.getActivePartsWithFallback();
        return (index$1.h("ion-picker-column", { color: this.color, disabled: disabled, value: activePart.hour, numericInput: true, onIonChange: (ev) => {
    ...
    renderMinutePickerColumn(minutesData) {
        ...
        if (minutesData.length === 0)
            return [];
        const activePart = this.getActivePartsWithFallback();
        return (index$1.h("ion-picker-column", { color: this.color, disabled: disabled, value: activePart.minute, numericInput: true, onIonChange: (ev) => {
    ...
    renderDayPeriodPickerColumn(dayPeriodData) {
        ...
        return (index$1.h("ion-picker-column", { style: isDayPeriodRTL ? { order: '-1' } : {}, color: this.color, disabled: disabled, value: activePart.ampm, onIonChange: (ev) => {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'f1f8ca52cdd9cfc8394b0365c89c0d30cd7316e7', "aria-disabled": disabled ? 'true' : null, onFocus: this.onFocus, onBlur: this.onBlur, class: Object.assign({}, theme.createColorClasses(color, {
                [mode]: true,
            ...
            })) }, index$1.h("div", { key: '480068aa8072b60ac521646dfa82480c5f6ce6ef', class: "intersection-tracker", ref: (el) => (this.intersectionTrackerRef = el) }), this.renderDatetime(mode)));
    }
