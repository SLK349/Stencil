import { r as registerInstance, d as createEvent, h, e as getElement } from './index-a73b2c0c.js';
import { g as getTimeGivenProgression } from './cubic-bezier-acda64df.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-b07d7318.js';
import { s as shallowEqualStringMap, h as hasLazyBuild } from './helpers-5a2c111a.js';
import { c as createLockController } from './lock-controller-6e56849c.js';
import { t as transition } from './index-366e988b.js';
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await import('./swipe-back-60da1d15.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => { var _a; return (_a = this.ani) === null || _a === void 0 ? void 0 : _a.progressStep(step); }, (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
